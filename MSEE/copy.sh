...
SDIR=/home/pavelsh/disk/sonic-buildimage/target/debs
cp $SDIR/libhiredis0.13_0.13.3-2_amd64.deb debs
cp $SDIR/libhiredis-dev_0.13.3-2_amd64.deb debs
cp $SDIR/libnl-3-200_3.2.27-1_amd64.deb debs
cp $SDIR/libnl-genl-3-200_3.2.27-1_amd64.deb debs
cp $SDIR/libnl-route-3-200_3.2.27-1_amd64.deb debs
